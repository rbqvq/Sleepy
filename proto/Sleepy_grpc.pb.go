...
func (c *sleepyClient) RegisterDevice(ctx context.Context, in *Device, opts ...grpc.CallOption) (*RegisterResponse, error) {
	...
	err := c.cc.Invoke(ctx, Sleepy_RegisterDevice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sleepyClient) Unregister(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Sleepy_Unregister_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sleepyClient) ReportDeviceState(ctx context.Context, in *State, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Sleepy_ReportDeviceState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSleepyServer must be embedded to have
...
func (UnimplementedSleepyServer) ReportDeviceState(context.Context, *State) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ReportDeviceState not implemented")
}
func (UnimplementedSleepyServer) mustEmbedUnimplementedSleepyServer() {}
func (UnimplementedSleepyServer) testEmbeddedByValue()                {}
...
func RegisterSleepyServer(s grpc.ServiceRegistrar, srv SleepyServer) {
	// If the following call panics, it indicates UnimplementedSleepyServer was
